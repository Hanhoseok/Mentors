...
export const interestCategories: InterestCategory[] = [
  {
    ...
    emoji: '💻',
    backendTag: 'it',
    children: ['보안', '소프트웨어', '양자컴퓨터', '인공지능', '인터넷', '클라우드', 'IT솔루션 구축'],
  },
  {
    name: '반도체',
    emoji: '💾',
    backendTag: 'semiconductor',
    children: ['반도체 부품소재', '반도체 장비', '반도체 파운드리', '반도체패키징', '반도체팹리스', '종합반도체'],
  },
  {
    name: '배터리',
    emoji: '🔋',
  ...
  },
  {
    ...
    emoji: '💵',
    backendTag: 'finance',
    children: ['결제서비스', '금융그룹', '금융기기', '금융상품거래소', '벤처캐피탈', '보험', '신용평가', '암호화폐', '은행', '증권', '카드'],
  },
  {
    name: '엔터테인먼트',
    emoji: '🎬',
  ...
  },
  {
    ...
    emoji: '🚗',
    backendTag: 'tech',
    children: ['수소차', '오토바이', '자동차부품', '자동차브랜드', '자동차유통', '전기차', '전기차 부품'],
  },
  {
    name: '스마트폰',
    emoji: '📱',
