...
export const mentorCatalog: MentorProfile[] = [
  ...
  },
  {
    ...
    name: '존 보글',
    title: '배당과 장기투자 멘토',
    oneLiner: '안정적인 배당과 장기 복리를 차분하게 짚어 주는 멘토',
    philosophy: '꾸준한 배당과 현금흐름에 집중하면 변동성 속에서도 흔들림이 줄어든다고 봅니다.',
    idealFor: '안정적인 현금흐름과 장기 투자 기준을 세우고 싶은 사용자',
    accentColor: '#355CDE',
    focusTags: ['dividend', 'value', 'etf', 'finance', 'domestic-stock', 'us-stock'],
    experienceMatch: ['beginner', 'exploring'],
    riskMatch: ['steady', 'balanced'],
    styleMatch: ['gentle', 'structured'],
    goalMatch: ['build-habit', 'understand-news'],
    strengths: ['배당·현금흐름 분석', '장기 복리의 힘', '차분한 원칙 중심 설명'],
  },
  {
    id: 4,
    slug: 'mark-minervini',
    name: '마크 미너비니',
    title: '모멘텀 투자 멘토',
    oneLiner: '시장 주도주와 추세, 거래량을 읽고 규율 있는 매매를 도와주는 모멘텀 멘토',
    philosophy: '강한 추세에 올라타되 손실은 빠르게 끊는 규율이 결국 수익을 지킨다고 봅니다.',
    idealFor: '시장 흐름과 주도주를 적극적으로 따라가며 매매 기준을 세우고 싶은 사용자',
    accentColor: '#D9822B',
    focusTags: ['semiconductor', 'battery', 'ai', 'defense', 'energy', 'crypto', 'us-stock', 'domestic-stock'],
    experienceMatch: ['exploring', 'confident'],
    riskMatch: ['bold', 'balanced'],
    styleMatch: ['challenging', 'structured'],
    goalMatch: ['find-style', 'understand-news'],
    strengths: ['추세·주도주 분석', '거래량과 상대강도 읽기', '손절 규율과 리스크 관리'],
  },
];
